...
$("#user-information").ready(function() {
	$.ajax({
		...
		success: function(r) {
			...
			$("#statistics").append("<tr><td>"+r.statistics.populartime+"</td><td>"+r.statistics.avgSmokesDay+"</td><td id=\"tmsk\">"+r.statistics.totalSmokesMonth+"</td><td>$"+r.statistics.moneySpent+"</td><td>$"+r.statistics.moneySaved+"</td><td>"+r.statistics.cigarettesNotSmoked+"</td></tr>");
