...
?>
	<div class="body-container">	
		<div class="wrapper">
			...
			<center><form id="log-smoke"><button id="log-button" type="submit">Log Smoke</button></form></center>
			<div class="main-view">
		    	...
		    	<div id="myTabContent" class="tab-content">
		      		<div role="tabpanel" class="tab-pane fade in active" id="profile" aria-labelledBy="profile-tab">
		      			<div class="page-header"><button type="button" id="edit-profile" aria-label="Edit"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button><h1>Your Profile</h1></div>
